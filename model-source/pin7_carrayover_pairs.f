...
C       
C     Modified from PIN7 to use lagk carryover pairs instead of 
C      a single value ICO
      SUBROUTINE PIN7_CO (P, C, ITA, ITB, JLAG, JK, METENG, 
...
C
      ...
      REAL TLRC, QBNTL, IINFL, IOUTFL, ISTOR, LAGTBL, KTBL, ICO
      INTEGER ISTPA, ISTPB, LAGDT, NLAGK, NDFLT, ITA, ITB, JLAG, JK
      DIMENSION LAGTBL(*), KTBL(*), ICO(*)
...
460      CONTINUE
      MXCOL=int(X/ITA + 2)
CZC      WRITE(*,*) "MXCOL =", MXCOL, "X=", X, "ITA=", ITA
      GO TO 480
